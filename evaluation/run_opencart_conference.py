"""Run the implementation-centric ARES evaluation on OpenCart."""
...
OUTPUT_DIRECTORY = Path("results/opencart")
...
def save_text_report(
    ...
    report_lines = [
        "ARES OpenCart Conference Evaluation",
        "=" * 42,
        "",
...
def main() -> None:
    """Execute OpenCart and generate evaluation artifacts."""
    ...
    result = runner.run_route_experiment(
        experiment_name="opencart_conference_evaluation",
    ...
    raw_result_path = (
        OUTPUT_DIRECTORY
        / "opencart_raw_result.json"
    )

    summary_path = (
        OUTPUT_DIRECTORY
        / "opencart_evaluation_summary.json"
    )

    text_report_path = (
        OUTPUT_DIRECTORY
        / "opencart_conference_report.txt"
    )
    ...
    print()
    print("=" * 60)
    print("ARES OpenCart Conference Evaluation")
    print("=" * 60)
    print(
        "Workflow completed: "
